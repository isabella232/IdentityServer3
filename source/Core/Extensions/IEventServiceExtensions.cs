...
namespace IdentityServer3.Core.Extensions
{
    internal static class IEventServiceExtensions
    {
        ...
        public static async Task RaiseResetPasswordSuccessEventAsync(this IEventService events,
            string username, string signInMessageId, SignInMessage signInMessage)
        {
            var evt = new Event<LocalLoginDetails>(
                ...
                EventTypes.Success,
                EventConstants.Ids.ResetPasswordSuccess,
                new LocalLoginDetails
                {
                    SignInId = signInMessageId,
                    SignInMessage = signInMessage,
        ...
        public static async Task RaiseResetPasswordFailureEventAsync(this IEventService events,
            string username, string signInMessageId, SignInMessage signInMessage, string error)
        {
            var evt = new Event<LocalLoginDetails>(
                EventConstants.Categories.Authentication,
                ...
                EventTypes.Failure,
                EventConstants.Ids.ResetPasswordFailure,
                new LocalLoginDetails
                {
                    SignInId = signInMessageId,
                    SignInMessage = signInMessage,
        ...
        public static async Task RaiseResetPasswordCallbackSuccessEventAsync(this IEventService events)
        {
            var evt = new Event<LocalLoginDetails>(
                EventConstants.Categories.Authentication,
                Resources.Events.ResetPasswordSuccess,
                EventTypes.Success,
                EventConstants.Ids.ResetPasswordCallbackSuccess);

            await events.RaiseEventAsync(evt);
        }

        public static async Task RaiseResetPasswordCallbackFailureEventAsync(this IEventService events, string error)
        {
            var evt = new Event<LocalLoginDetails>(
                EventConstants.Categories.Authentication,
                Resources.Events.ResetPasswordFailure,
                EventTypes.Failure,
                EventConstants.Ids.ResetPasswordCallbackFailure,
                error);
